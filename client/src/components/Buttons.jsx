  ...
  return (
    ...
    <div className='bg-white py-20'>
        <div className=' max-w-screen-2xl container mx-auto xl:px-24 px-4'>
            <motion.h1 className='text-4xl md:text-6xl pt-10 px-10 text-center font-semibold '
            ...
            <motion.p className='md:text-2xl text-center lg:px-20 md:px-10 mt-10'
            initial={{ opacity: 0, y: 20}}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true}}
            transition={{ duration: 2, delay: 0.5 }}>
              Let me tell you a little secret: Getting people to your website is not the hard part of the process. Converting those curious eyeballs into money is.</motion.p>
        </div>
        <div>
        <div className="max-w-screen-2xl container mx-auto p-4">
      <div className="grid gap-6 sm:grid-cols-1 lg:grid-cols-3">
        <motion.div className=" p-6 rounded-lg"
    ...
    <motion.div className=' max-w-screen-2xl container mx-auto xl:px-24 px-4'
    initial={{ opacity: 0, y: 20}}
    whileInView={{ opacity: 1, y: 0 }}
    viewport={{ once: true}}
    transition={{ duration: 1, delay: 0.5 }}>
